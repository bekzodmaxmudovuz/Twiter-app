                ...
                <>
                        ...
                        <div className="flex flex-row items-center gap-3">
                            ...
                            <div>
                                <div className="flex flex-row items-center gap-2">
                                    ...
                                    <span className="text-neutral-700 cursor-pointer hover-underline hidden md:block">
                    ...
                    {isFetchingComment ? (
                        ...
                        comments.map((comment) => (
                            <CommentItem comment={comment} key={comment._id} user={JSON.parse(JSON.stringify(session.currentUser))} setComments={setComments}  comments={comments}/>
                        ))
                    )}
                </>
            )}
